...
public class AcoolyCoder {
    // 生成代码的目标模块
    static String MODULE_NAME = "acooly-showcase-v5";
    // 生成代码的根包
    static String ROOT_PACKAGE = "com.acooly.showcase.daliy";
    // 生成代码的管理视图相对路径
    static String MANAGE_VIEW_PATH = "/manage/showcase/fanbase";
    // 配置表名转换为实体名时，需要忽略的表前缀。例如配置：p_ 则表示p_customer(表名) -> Customer(实体类名)
    static String TABLE_IGNOR_PREFIX = "dm_";
    // 生成代码的表
    static String[] TABLES = {"dm_fanbase"};
    ...
    public static void main(String[] args) {
        ...
        service.generateTable((AcoolyCoderListener) config, TABLES);
    }
