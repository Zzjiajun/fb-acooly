...
<div>
    <form id="manage_shopParentCategories_editform" class="form-horizontal" action="/manage/shop/shopParentCategories/<#if action=='create'>saveJson<#else>updateJson</#if>.html" method="post" >
		<@jodd.form bean="shopParentCategories" scope="request">
        <input name="id" type="hidden" />
		<div class="card-body">
			<div class="form-group row">
				<label class="col-sm-3 col-form-label">父级分类名称</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="40" placeholder="请输入父级分类名称..." name="name" class="easyui-validatebox form-control form-words" data-words="255" data-options="required:true"></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-3 col-form-label">父级分类标识</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="40" placeholder="请输入父级分类标识..." name="slug" class="easyui-validatebox form-control form-words" data-words="255" data-options="required:true"></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-3 col-form-label">父级分类描述</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="40" placeholder="请输入父级分类描述..." name="description" class="easyui-validatebox form-control form-words" data-words="999,999,999" ></textarea>
				</div>
			</div>
<#--			<div class="form-group row">-->
