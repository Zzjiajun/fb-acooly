                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills dropdown-menu-lg-right">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#revenue-chart1" data-toggle="tab">数据表格</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#sales-chart1" data-toggle="tab">数据折线图</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="tab-content p-0">
                                <!-- Morris chart - Sales -->
                                <div class="chart tab-pane active" id="revenue-chart1" style="position: relative; height: 500px;">
                                ...
                                <div class="chart tab-pane" id="sales-chart1" style="position: relative; height: 500px; width: 100%">
                                    <div id="chartContainer1" style="width: 1200px; height: 500px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            $('#manage_clickUrl_datagrid').datagrid({
