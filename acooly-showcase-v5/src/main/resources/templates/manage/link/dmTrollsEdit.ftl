...
<div>
    <form id="manage_dmTrolls_editform" class="form-horizontal" action="/manage/link/dmTrolls/<#if action=='create'>saveJson<#else>updateJson</#if>.html" method="post" >
		<@jodd.form bean="dmTrolls" scope="request">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<textarea rows="3" cols="40" placeholder="请输入访问路径..." name="trollsPath" class="easyui-validatebox form-control form-words" data-words="255" ></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-3 col-form-label">访问设备</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="40" placeholder="请输入访问设备..." name="trollsDevice" class="easyui-validatebox form-control form-words" data-words="255" ></textarea>
				</div>
			</div>
			<div class="form-group row">
